...
lemma replyRemoveTCB_simple[wp]:
  "\<lbrace>\<top>\<rbrace> replyRemoveTCB t \<lbrace>\<lambda>rv. st_tcb_at' simple' t\<rbrace>"
...
lemma cancelIPC_simple[wp]:
  ...
  apply (wpsimp wp: setThreadState_st_tcb cancelSignal_simple
                    set_reply'.set_wp gts_wp' threadSet_wp
...
(* FIXME RT: this doesn't seem to be used. And why this name? 
...
lemma replyUnlink_valid_inQ_queues[wp]:
  "replyUnlink replyPtr tptr \<lbrace>valid_inQ_queues\<rbrace>"
  ...
  have P:
    ...
    apply (rule corres_split')
      ...
      apply (wp hoare_vcg_const_Ball_lift set_ep_valid_objs'
          | (clarsimp simp: valid_ep'_def valid_pspace_def valid_ep_def)
