...
>     assert (tptr == tcbPtr) "replyPop: replyTCB is equal to tcbPtr"
...
>     reply <- getReply replyPtr
>     tptr <- maybeToMonad  $ replyTCB reply
>     assert (tptr == tcbPtr) "replyRemove: replyTCB is equal to tcbPtr"
>     state <- getThreadState tcbPtr
...
>     assert (tptr == tcbPtr) "replyTCB is equal to tcbPtr"
>     state <- getThreadState tcbPtr
